    ...
    [app-layout
           [ui/Segment
            ...
            [:div.padded
             ...
             [:p "There’s a persistent search bar at the top of the website, no matter what page you’re on. Simply type in a name you’re looking for and you’re off to the races! By clicking the “Offerings” button at the top of the left-hand menu, a more " [:a {:href (path-for @hashroutes? :route.offerings/search)} "detailed offering search page"] " is available, where you can filter by a number of intuitive parameters like price, buy now vs. auction, and so on. "]
